...
### Task 3: The gate and the cost ledger arithmetic

**Files:**
- Create: `src/domain/gate.ts`, `src/domain/cost.ts`
- Test: `test/domain/gate.test.ts`, `test/domain/cost.test.ts`
...
Create `test/domain/gate.test.ts`:
...
Create `test/domain/cost.test.ts`:
...
Run: `npx vitest run test/domain/gate.test.ts test/domain/cost.test.ts`
Expected: FAIL, both modules unresolved.

- [ ] **Step 3: Create `src/domain/gate.ts`**
...
- [ ] **Step 4: Create `src/domain/cost.ts`**
...
```bash
git add src/domain/gate.ts src/domain/cost.ts test/domain/gate.test.ts test/domain/cost.test.ts
git commit -m "feat: add score gate and model cost arithmetic"
```
