...
**70% validated:** Cloudflare Workers, D1, Hono, React with Vite, hand written SQL, OpenAI structured outputs, and the Jobicy public REST API. All boring, all documented, all things I can search for an answer about when they break.
